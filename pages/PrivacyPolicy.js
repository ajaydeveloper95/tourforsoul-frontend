      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to tourforsoul, sikar,rajsthan 332001.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to tourforsoul, accessible from{" "}
            <a
              href="https://tourforsoul.in"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://tourforsoul.in
            </a>
          </p>
        </li>
        <li>

            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                <p className="mb-8 text-base text-body-color">
                  tourforsoul is not only a Company. It way's to connect with the nature and your dream place. Just connect with the tourforsoul community and explore the world.
                </p>
                <a
                  href="/#"
